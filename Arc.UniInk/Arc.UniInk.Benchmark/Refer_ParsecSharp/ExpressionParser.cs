...
namespace ParsecSharp.Examples
{
    ...
    public class Double : INumber<Double>
    {
        ...
        public Double Add(Double value) => new(this.Value + value.Value);

        public Double Sub(Double value) => new(this.Value - value.Value);

        public Double Mul(Double value) => new(this.Value * value.Value);

        public Double Div(Double value) => new(this.Value / value.Value);
    }
    ...
    public class IntegerExpression : INumber<IntegerExpression>
    {
        ...
        public IntegerExpression Add(IntegerExpression value) => new(Expression.Add(this._value, value._value));

        public IntegerExpression Sub(IntegerExpression value) => new(Expression.Subtract(this._value, value._value));

        public IntegerExpression Mul(IntegerExpression value) => new(Expression.Multiply(this._value, value._value));
